    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <Link href="/" className="text-4xl font-bold text-slate-900 hover:opacity-80 transition-opacity">GateSign</Link>
          <p className="text-slate-500 mt-2">Digitales Check-in Terminal für Ihr Unternehmen</p>
        </div>
