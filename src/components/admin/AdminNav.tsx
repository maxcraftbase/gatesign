...
export function AdminNav({ slug, role, userName, companyName, terminals = [] }: {
  ...
  const isInSettings = pathname.startsWith(`${base}/settings`) || pathname.startsWith(`${base}/users`) || pathname.startsWith(`${base}/audit`) || pathname.startsWith(`${base}/documents`) || pathname.startsWith(`${base}/account`) || pathname.startsWith(`${base}/avv`) || pathname.startsWith(`${base}/billing`)
