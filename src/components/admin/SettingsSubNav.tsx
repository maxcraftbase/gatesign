...
import { SlidersHorizontal, MonitorCheck, FileText, Users, ScrollText, CircleUser, FileSignature, CreditCard } from 'lucide-react'
  ...
  const groups: TabGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: `${base}/billing`, label: 'Abrechnung', icon: <CreditCard className="w-3.5 h-3.5" /> },
        { href: `${base}/avv`,     label: 'AVV',       icon: <FileSignature className="w-3.5 h-3.5" /> },
